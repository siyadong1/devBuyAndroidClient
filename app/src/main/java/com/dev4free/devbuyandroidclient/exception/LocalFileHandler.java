package com.dev4free.devbuyandroidclient.exception;

import android.content.Context;
import android.os.Looper;
import android.widget.Toast;

import com.dev4free.devbuyandroidclient.utils.FileUtils;
...
public class LocalFileHandler extends BaseExceptionHandler
{
	...
	public void saveLog(Throwable ex)
	{
		try
		{
			File errorFileDir = new File(FileUtils.getDiskCacheDir(context) + "/log");
			File errorFile = new File(FileUtils.getDiskCacheDir(context) + "/log/crash.log");
